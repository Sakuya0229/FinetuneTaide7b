...
ckpt_dir = "./exp1"
num_epoch = 3  # 設定訓練的總Epoch數 (數字越高，訓練越久)
LEARNING_RATE = 2e-4  # 設定學習率


"""Set Hyperarameters for Fine-tuning: It is recommmended NOT to change codes in this cell """
